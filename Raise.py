...
try:
    ...
    if c == 'Shashank':
       raise ValueError("You aren't allowed.Tata ,Bye-Bye, Khatam, Gaya, Good-Bye.")
    print("Value isn't defined.")